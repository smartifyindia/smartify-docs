---
title: "TAC 1"
description: "A single-button Zigbee smart switch for direct load control or scene triggering. Features a backlit button with customizable icon and is available in polypropylene (PP) or anti-glare glass (AG) in black, white, or gold."
---
