...
<Cards>
  <Card href="./ir-blaster-wifi" title="IR Blaster (WiFi)">
    Every remote. One app. — ₹2,125
  </Card>
  <Card href="./irplusrf-blaster-wifi" title="IR+RF Blaster (WiFi)">
    IR and RF. Nothing left out. — ₹3,000
  </Card>
  <Card href="./ir-blaster-w--analog-screen-temp-and-humidity-sensor-wifi" title="IR Blaster w/ Analog Screen, Temp & Humidity Sensor (WiFi)">
