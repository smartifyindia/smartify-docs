...
- [IR Blaster (WiFi)](./ir-blaster-wifi) — ₹2,125  
  Every remote. One app.
- [IR+RF Blaster (WiFi)](./irplusrf-blaster-wifi) — ₹3,000  
  IR and RF. Nothing left out.
- [IR Blaster w/ Analog Screen, Temp & Humidity Sensor (WiFi)](./ir-blaster-w--analog-screen-temp-and-humidity-sensor-wifi) — ₹4,750  
