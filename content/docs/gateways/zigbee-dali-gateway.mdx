...
![Zigbee DALI Gateway](/images/Zigbee DALI Gateway.png)
...
> **Important:** Does not power lighting loads directly. Communicates with DALI drivers over the bus only.

> **Requires:** Zigbee coordinator or hub. Existing DALI bus installation.
